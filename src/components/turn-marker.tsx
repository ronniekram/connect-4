...
const Marker = ({ player }: { player: 1 | 2 }) => (
  <svg width="197" height="165" viewBox="0 0 197 165" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      <filter id="filter0_d_5_3077" x="0" y="0.683594" width="197" height="164.316" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
