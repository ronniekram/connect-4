export const ButtonPlayers = () => (
	<svg width="82" height="46" viewBox="0 0 82 46" fill="none" xmlns="http://www.w3.org/2000/svg">
		<circle cx="59" cy="23" r="23" fill="currentColor" />
		<circle cx="59" cy="23" r="20" fill="transparent" />
		<path
			...
			fill="currentColor"
		/>
		<path d="M62.375 14.6666V19.6536H59.375V14.6666H62.375Z" fill="currentColor" />
		<path d="M70.7083 14.6666V19.6536H67.7083V14.6666H70.7083Z" fill="currentColor" />
		<circle cx="23" cy="23" r="23" fill="currentColor" />
		<circle cx="23" cy="23" r="20" fill="transparent" />
		<path
			...
			fill="currentColor"
		/>
		<path d="M26.375 14.6666V19.6536H23.375V14.6666H26.375Z" fill="currentColor" />
